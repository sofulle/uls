...
static void printcols_c(ls_list **names, int rows, int num, int maxlen) {
...
static void printcols_x(ls_list **names, int rows, int cols, int maxlen) {
    int j = 0;
    int tempcols = cols;
...
static void printrow_g(ls_list **names, int maxlen) {
...
static void print_names(ls_list **names, int maxlen, int wincol, st_fl *fl) {
    int rows;
